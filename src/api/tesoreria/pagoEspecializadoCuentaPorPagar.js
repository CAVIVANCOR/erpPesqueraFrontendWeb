// src/api/tesoreria/pagoEspecializadoCuentaPorPagar.js
// Funciones de integración API REST para Pago Especializado Cuenta Por Pagar

import axios from "axios";
import { useAuthStore } from "../../shared/stores/useAuthStore";

const API_URL = `${import.meta.env.VITE_API_URL}/pagos-especializados-cxp`;
...
/**
 * Procesar pago especializado de cuenta por pagar
 */
 ...
 */
export async function actualizarUrlVoucherConsolidado(movimientoEgresoId, urlPdf) {
  const res = await axios.patch(`${API_URL}/voucher-consolidado/${movimientoEgresoId}`, 
    { urlPdf }, 
    { headers: getAuthHeaders() }
  );
  return res.data;
...
/**
 * Actualizar URL del comprobante de impuesto/detracción en PagoCuentaPorPagar
 */
