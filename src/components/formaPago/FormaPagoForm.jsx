// src/components/formaPago/FormaPagoForm.jsx
// Formulario profesional para FormaPago. Cumple la regla transversal ERP Megui.
...
export default function FormaPagoForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
