// src/components/permisoAutorizacion/PermisoAutorizacionForm.jsx
// Formulario profesional para PermisoAutorizacion. Cumple regla transversal ERP Megui.
import React from 'react';
import { Button } from 'primereact/button';
import { InputText } from 'primereact/inputtext';

export default function PermisoAutorizacionForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
