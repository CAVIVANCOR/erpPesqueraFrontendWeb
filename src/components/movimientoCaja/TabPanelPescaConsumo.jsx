// src/components/movimientoCaja/TabPanelPescaConsumo.jsx
/**
 * TabPanel para Movimientos de Caja - Módulo Pesca Consumo
 * Muestra y valida los detalles de entregas a rendir de Pesca Consumo
 * 
 * @author ERP Megui
 */
...
import DetEntregaRendirNovedadConsumo from "../novedadPescaConsumo/DetEntregaRendirNovedadConsumo";

export default function TabPanelPescaConsumo({
  entregaARendir,
  movimientos,
  personal,
  centrosCosto,
