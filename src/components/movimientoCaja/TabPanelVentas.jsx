// src/components/movimientoCaja/TabPanelVentas.jsx
/**
 * TabPanel para Movimientos de Caja - Módulo Ventas
 * Muestra y valida los detalles de entregas a rendir de Ventas
 * 
 * @author ERP Megui
 */
...
import DetEntregaRendirVentas from "../cotizacionVentas/DetEntregaRendirVentas";

export default function TabPanelVentas({
  entregaARendir,
  movimientos,
  personal,
  centrosCosto,
