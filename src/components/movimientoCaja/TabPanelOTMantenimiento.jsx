// src/components/movimientoCaja/TabPanelOTMantenimiento.jsx
/**
 * TabPanel para Movimientos de Caja - Módulo OT Mantenimiento
 * Muestra y valida los detalles de entregas a rendir de OT Mantenimiento
 * 
 * @author ERP Megui
 */
...
import DetEntregaRendirOTMantenimiento from "../oTMantenimiento/DetEntregaRendirOTMantenimiento";

export default function TabPanelOTMantenimiento({
  entregaARendir,
  movimientos,
  personal,
  centrosCosto,
