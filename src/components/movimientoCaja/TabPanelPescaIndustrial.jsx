// src/components/movimientoCaja/TabPanelPescaIndustrial.jsx
/**
 * TabPanel para Movimientos de Caja - Módulo Pesca Industrial
 * Muestra y valida los detalles de entregas a rendir de Pesca Industrial
 * 
 * @author ERP Megui
 */
...
import DetEntregaRendirPescaIndustrial from "../temporadaPesca/DetEntregaRendirPescaIndustrial";

export default function TabPanelPescaIndustrial({
  entregaARendir,
  movimientos,
  personal,
  centrosCosto,
