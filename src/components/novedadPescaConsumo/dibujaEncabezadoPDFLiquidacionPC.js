/**
 * dibujaEncabezadoPDFLiquidacionPC.js
 * 
 * Dibuja el encabezado del PDF de liquidación de Pesca Consumo
 * 
 * @author ERP Megui
 * @version 1.0.0
 */
...
export function dibujaEncabezadoPDFLiquidacionPC(
  page,
  entregaARendir,
  empresa,
  fontBold,
  ...
  rightY -= 15;
  const fechaLiquidacion = entregaARendir.fechaLiquidacion
  ...
  const novedad = entregaARendir.novedadPescaConsumo
    ? `${entregaARendir.novedadPescaConsumo.nombreNovedad || "N/A"}`
    : "N/A";
  page.drawText(`Novedad: ${novedad}`, {
    x: margin + 10,
    y: yPosition,
    size: 9,
    font: fontBold,
