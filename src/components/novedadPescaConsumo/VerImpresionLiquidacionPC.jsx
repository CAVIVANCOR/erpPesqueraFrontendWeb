...
const VerImpresionLiquidacionPC = ({
  ...
  const generarPdfWrapper = async () => {
    ...
    if (!response.ok) throw new Error("No se pudo cargar la entrega completa desde el servidor");
  ...
  return (
    ...
    >
      <PDFGeneratedUploader
        ...
        moduleName="entregas-rendir-consumo"
        entityId={entregaARendirId}
        fileName={`liquidacion-pesca-consumo-${entregaARendirId}.pdf`}
