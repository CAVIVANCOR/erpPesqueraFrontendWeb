// src/components/tipoProvieneDe/TipoProvieneDeForm.jsx
// Formulario profesional para TipoProvieneDe. Cumple regla transversal ERP Megui.
import React from 'react';
import { Button } from 'primereact/button';
import { InputText } from 'primereact/inputtext';

export default function TipoProvieneDeForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
