...
// Formulario profesional para TipoVehiculo. Cumple la regla transversal ERP Megui.
...
export default function TipoVehiculoForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
