/**
 * PdfDetMovEntregaRendirComprasCard.jsx - WRAPPER para Sistema PDF V2
 *
 * Componente wrapper para comprobantes de movimientos en Requerimiento Compra.
...
const PdfDetMovEntregaRendirComprasCard = ({
  ...
  return (
    <PDFDocumentManager
      moduleName="det-movs-entrega-rendir-reqcompras-comprobante"
