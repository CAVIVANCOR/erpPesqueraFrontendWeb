...
export function dibujaTotalesYFirmaPDFLiquidacionCompras(page, entregaARendir, movimientos, fontBold, fontRegular, startY, pageWidth) {
  ...
  page.drawText("Sistema ERP Megui - Compras", {
