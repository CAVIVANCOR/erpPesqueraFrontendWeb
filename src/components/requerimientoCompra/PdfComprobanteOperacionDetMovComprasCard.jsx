/**
 * PdfComprobanteOperacionDetMovComprasCard.jsx - WRAPPER para Sistema PDF V2
 *
 * Componente wrapper para comprobantes de operación en Requerimiento Compra.
...
const PdfComprobanteOperacionDetMovComprasCard = ({
  control,
  errors,
  setValue,
  watch,
  ...
  return (
    <PDFDocumentManager
      moduleName="det-movs-entrega-rendir-reqcompras-operacion"
...
export default PdfComprobanteOperacionDetMovComprasCard;