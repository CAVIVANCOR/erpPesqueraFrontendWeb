/**
 * Formulario para gestión de Tipos de Estado de Producto
...
const TipoEstadoProductoForm = ({ tipoEstadoProducto, onGuardar, onCancelar }) => {
  const [loading, setLoading] = useState(false);
  const esEdicion = !!tipoEstadoProducto;
  ...
  useEffect(() => {
    if (tipoEstadoProducto) {
      setValue("nombre", tipoEstadoProducto.nombre || "");
      setValue("descripcion", tipoEstadoProducto.descripcion || "");
      setValue("activo", tipoEstadoProducto.activo !== undefined ? tipoEstadoProducto.activo : true);
      setValue("paraCompras", tipoEstadoProducto.paraCompras || false);
      setValue("paraVentas", tipoEstadoProducto.paraVentas || false);
    } else {
      reset({
        nombre: "",
        descripcion: "",
  ...
  }, [tipoEstadoProducto, setValue, reset]);
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputText
                id="descripcion"
                {...field}
                placeholder="Descripción del tipo de estado de producto (opcional)"
            ...
            render={({ field }) => (
              <div className="p-field-checkbox">
                ...
                <label htmlFor="activo" className="p-checkbox-label">
                  Tipo de estado de producto activo
                </label>
              </div>
            )}
          />
