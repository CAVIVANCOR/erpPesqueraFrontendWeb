...
export default function DetalleMovimientoAlmacenForm({ 
  ...
  const [movimientoAlmacenId, setMovimientoAlmacenId] = React.useState(defaultValues.movimientoAlmacenId || null);
  const [productoId, setProductoId] = React.useState(defaultValues.productoId || null);
  const [cantidad, setCantidad] = React.useState(defaultValues.cantidad || null);
  const [pesoNeto, setPesoNeto] = React.useState(defaultValues.pesoNeto || null);
  const [lote, setLote] = React.useState(defaultValues.lote || '');
  const [fechaProduccion, setFechaProduccion] = React.useState(defaultValues.fechaProduccion ? new Date(defaultValues.fechaProduccion) : null);
  ...
  const [fechaIngreso, setFechaIngreso] = React.useState(defaultValues.fechaIngreso ? new Date(defaultValues.fechaIngreso) : null);
  const [nroSerie, setNroSerie] = React.useState(defaultValues.nroSerie || '');
  const [nroContenedor, setNroContenedor] = React.useState(defaultValues.nroContenedor || '');
  const [ubicacionOrigenId, setUbicacionOrigenId] = React.useState(defaultValues.ubicacionOrigenId || null);
  const [ubicacionDestinoId, setUbicacionDestinoId] = React.useState(defaultValues.ubicacionDestinoId || null);
  const [paletaAlmacenId, setPaletaAlmacenId] = React.useState(defaultValues.paletaAlmacenId || null);
  const [estadoMercaderiaId, setEstadoMercaderiaId] = React.useState(defaultValues.estadoMercaderiaId || null);
  const [estadoCalidadId, setEstadoCalidadId] = React.useState(defaultValues.estadoCalidadId || null);
  ...
  const [detalleReqCompraId, setDetalleReqCompraId] = React.useState(defaultValues.detalleReqCompraId || null);

  React.useEffect(() => {
    setMovimientoAlmacenId(defaultValues.movimientoAlmacenId ? Number(defaultValues.movimientoAlmacenId) : null);
    setProductoId(defaultValues.productoId ? Number(defaultValues.productoId) : null);
    ...
    setFechaProduccion(defaultValues.fechaProduccion ? new Date(defaultValues.fechaProduccion) : null);
    setFechaVencimiento(defaultValues.fechaVencimiento ? new Date(defaultValues.fechaVencimiento) : null);
    setFechaIngreso(defaultValues.fechaIngreso ? new Date(defaultValues.fechaIngreso) : null);
    setNroSerie(defaultValues.nroSerie || '');
    setNroContenedor(defaultValues.nroContenedor || '');
    setUbicacionOrigenId(defaultValues.ubicacionOrigenId ? Number(defaultValues.ubicacionOrigenId) : null);
    setUbicacionDestinoId(defaultValues.ubicacionDestinoId ? Number(defaultValues.ubicacionDestinoId) : null);
    setPaletaAlmacenId(defaultValues.paletaAlmacenId ? Number(defaultValues.paletaAlmacenId) : null);
    setEstadoMercaderiaId(defaultValues.estadoMercaderiaId ? Number(defaultValues.estadoMercaderiaId) : null);
    setEstadoCalidadId(defaultValues.estadoCalidadId ? Number(defaultValues.estadoCalidadId) : null);
    ...
    setDetalleReqCompraId(defaultValues.detalleReqCompraId ? Number(defaultValues.detalleReqCompraId) : null);
  }, [defaultValues]);

  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({
      movimientoAlmacenId: movimientoAlmacenId ? Number(movimientoAlmacenId) : null,
      ...
      ubicacionDestinoId: ubicacionDestinoId ? Number(ubicacionDestinoId) : null,
      ...
      observaciones,
      detalleReqCompraId: detalleReqCompraId ? Number(detalleReqCompraId) : null
    });
  };
