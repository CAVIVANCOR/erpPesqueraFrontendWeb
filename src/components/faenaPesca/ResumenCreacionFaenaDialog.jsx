/**
 * ResumenCreacionFaenaDialog.jsx
 * 
 * Componente modal para mostrar el resumen de la creación de una faena completa
...
/**
 * Componente ResumenCreacionFaenaDialog
 ...
 */
const ResumenCreacionFaenaDialog = ({ visible, onHide, resumen }) => {
    ...
    <Dialog
      ...
      header={
        <div className="flex align-items-center gap-2">
          ...
          <span>Faena Creada Exitosamente</span>
        </div>
      }
      footer={footer}
      style={{ width: '800px' }}
          ...
          <div className="grid">
            ...
            <div className="col-6">
              <div className="mb-2">
                ...
                <p className="mt-1 mb-0">{numeroResolucion || 'S/N'}</p>
              </div>
            </div>
          </div>
        </Card>
            ...
            <div className="flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0 mb-0">
                  La faena ha sido creada exitosamente con toda su documentación vigente.
                </p>
              </div>
            </div>
          </Card>
...
export default ResumenCreacionFaenaDialog;
