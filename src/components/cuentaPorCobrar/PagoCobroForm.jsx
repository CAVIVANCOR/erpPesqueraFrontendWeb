// src/components/cuentaPorCobrar/PagoCobroForm.jsx
...
export default function PagoCobroForm({
  visible,
  pago,
  isEdit,
  saldoPendiente,
  ...
  return (
    <Dialog
      visible={visible}
      style={{ width: "600px" }}
      header={isEdit ? "Editar Cobro" : "Registrar Cobro"}
      modal
      footer={footer}
      onHide={onHide}
    >
      <div className="p-fluid">
        <div className="field">
          <label htmlFor="fechaPago">
            Fecha de Cobro <span style={{ color: "red" }}>*</span>
          </label>
          <Calendar
            id="fechaPago"
        ...
        <div className="field">
          <label htmlFor="montoPago">
            Monto del Cobro <span style={{ color: "red" }}>*</span>
          </label>
          <InputNumber
            id="montoPago"
