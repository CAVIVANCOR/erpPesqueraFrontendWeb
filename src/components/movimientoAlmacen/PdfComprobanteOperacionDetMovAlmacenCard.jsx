/**
 * PdfComprobanteOperacionDetMovAlmacenCard.jsx
 *
 * Card para gestión de PDF de comprobante de operación de movimiento de caja en movimientos de almacén.
 * Permite subir, visualizar y descargar el PDF del comprobante de la operación MovCaja.
 * Patrón replicado EXACTAMENTE de PdfComprobanteOperacionDetMovContratoCard.jsx
 *
 * @author ERP Megui
 * @version 1.0.0
 */
...
const PdfComprobanteOperacionDetMovAlmacenCard = ({
  ...
  const handleDescargarPDF = () => {
    descargarPdf(
      urlComprobanteOperacionMovCaja,
      toast?.current,
      `comprobante-operacion-almacen-${movimientoIdNumber || 'documento'}.pdf`
    );
  };
      ...
      <div className="p-fluid">
        ...
        {mostrarCaptura && movimientoIdNumber && (
          <DocumentoCapture
            ...
            }/det-movs-entrega-rendir-mov-almacen-pdf/upload-pdf-operacion`}
