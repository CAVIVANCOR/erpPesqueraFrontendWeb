...
import DetMovsEntregaRendirMovAlmacenForm from "./DetMovsEntregaRendirMovAlmacenForm";
import { getResponsiveFontSize } from "../../utils/utils";
import {
  crearDetMovsEntregaRendirMovAlmacen,
  actualizarDetMovsEntregaRendirMovAlmacen,
...
export default function DetEntregaRendirMovAlmacen({
  ...
  const handleEliminarMovimiento = (movimiento) => {
    confirmDialog({
      ...
      accept: async () => {
        try {
          await eliminarDetMovsEntregaRendirMovAlmacen(movimiento.id);
          toast.current?.show({
            severity: "success",
            summary: "Éxito",
