...
export function dibujaTotalesYFirmaPDFLiquidacionMovAlmacen(page, entregaARendir, movimientos, fontBold, fontRegular, startY, pageWidth) {
  ...
  movimientos.forEach((mov) => {
    ...
    if (mov.tipoMovimiento?.esIngreso === true) totalIngresos += monto;
  ...
  page.drawText("Sistema ERP Megui - Movimiento de Almacén", {
    x: pageWidth - margin - 250, y: 30, size: 7, font: fontRegular, color: rgb(0.5, 0.5, 0.5),
  });
