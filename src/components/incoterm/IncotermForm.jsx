...
// Formulario profesional para Incoterm. Cumple la regla transversal ERP Megui.
import React from 'react';
import { Button } from 'primereact/button';
import { InputText } from 'primereact/inputtext';
import { Checkbox } from 'primereact/checkbox';

export default function IncotermForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-fluid">
      <div className="p-field">
        ...
        <InputText id="codigo" value={codigo} onChange={e => setCodigo(e.target.value)} required disabled={loading} maxLength={10} />
      </div>
      <div className="p-field">
        <label htmlFor="descripcion">Descripción*</label>
        <InputText id="descripcion" value={descripcion} onChange={e => setDescripcion(e.target.value)} required disabled={loading} maxLength={100} />
      </div>
