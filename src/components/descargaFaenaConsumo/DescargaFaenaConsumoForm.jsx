    ...
    <div className="p-fluid">
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            <div style={{ marginTop: "5px", fontSize: "14px" }}>
              <div>
                <strong>Lat:</strong>{" "}
                {coordenadasConfig.formatoDMS?.latitudDMS || "0° 0' 0\" N"}
              </div>
              <div>
                <strong>Lon:</strong>{" "}
                {coordenadasConfig.formatoDMS?.longitudDMS || "0° 0' 0\" W"}
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            <strong>📐 Formato decimal Fondeo:</strong>
            <div style={{ marginTop: "5px", fontSize: "14px" }}>
              <div>
                <strong>Lat:</strong>{" "}
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            <div style={{ marginTop: "5px", fontSize: "14px" }}>
              <div>
                <strong>Lat:</strong>{" "}
                {coordenadasFondeoConfig.formatoDMS?.latitudDMS || "0° 0' 0\" N"}
              </div>
              <div>
                <strong>Lon:</strong>{" "}
                {coordenadasFondeoConfig.formatoDMS?.longitudDMS || "0° 0' 0\" W"}
              </div>
            </div>
          </div>
        </div>
