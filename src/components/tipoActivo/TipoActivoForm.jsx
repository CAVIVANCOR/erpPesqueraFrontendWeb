// src/components/tipoActivo/TipoActivoForm.jsx
// Formulario profesional para TipoActivo. Cumple regla transversal ERP Megui.
import React from 'react';
import { Button } from 'primereact/button';
import { InputText } from 'primereact/inputtext';
import { Checkbox } from 'primereact/checkbox';

export default function TipoActivoForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({ codigo, nombre, descripcion, cesado });
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="p-fluid">
      <div className="p-field">
        ...
        <InputText id="codigo" value={codigo} onChange={e => setCodigo(e.target.value)} required disabled={loading} autoFocus />
      </div>
      <div className="p-field">
