...
const DetalleDireccionesEntidad = forwardRef(
  ({ entidadComercialId, readOnly = false, permisos = {} }, ref) => {
    ...
    ); // Estado global para texto del ubigeo
                  ...
                  <InputText
                    ...
                    value={
                      direccionSeleccionada?.ubigeo
                        ? `${direccionSeleccionada.ubigeo.codigo} - ${
                            direccionSeleccionada.ubigeo.nombreDistrito || "N/A"
                          }`
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ marginTop: 5 }}>
                        <div style={{ fontSize: "0.85rem", color: "#6c757d" }}>
                          {direccionSeleccionada.fechaCreacion
                            ? new Date(
                                direccionSeleccionada.fechaCreacion
                        ...
                        {direccionSeleccionada.personalCreador && (
                          <Tag
                            value={`${direccionSeleccionada.personalCreador.nombres} ${direccionSeleccionada.personalCreador.apellidos}`}
                            style={{
                              marginTop: 5,
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ marginTop: 5 }}>
                        <div style={{ fontSize: "0.85rem", color: "#6c757d" }}>
                          {direccionSeleccionada.fechaActualizacion
                            ? new Date(
                                direccionSeleccionada.fechaActualizacion
                              ).toLocaleString("es-PE", {
                                day: "2-digit",
                        ...
                        {direccionSeleccionada.personalActualizador && (
                          <Tag
                            value={`${direccionSeleccionada.personalActualizador.nombres} ${direccionSeleccionada.personalActualizador.apellidos}`}
                            style={{
                              marginTop: 5,
