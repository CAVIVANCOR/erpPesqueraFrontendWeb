/**
 * PdfComprobanteOperacionDetMovOTMantenimientoCard.jsx
 *
 * Card para gestión de PDF de comprobante de operación de movimiento de caja en OT de mantenimiento.
 * Permite subir, visualizar y descargar el PDF del comprobante de la operación MovCaja.
 * Replicado de PdfComprobanteOperacionDetMovContratoCard.jsx
 *
 * @author ERP Megui
 * @version 1.0.0
 */
...
const PdfComprobanteOperacionDetMovOTMantenimientoCard = ({
  ...
  const handleDescargarPDF = () => {
    descargarPdf(
      urlComprobanteOperacionMovCaja,
      toast?.current,
      `comprobante-operacion-ot-mantenimiento-${movimientoIdNumber || 'documento'}.pdf`
    );
  };
      ...
      <div className="p-fluid">
        ...
        {mostrarCaptura && movimientoIdNumber && (
          <DocumentoCapture
            ...
            }/det-movs-entrega-rendir-ot-mantenimiento-pdf/upload-pdf-operacion`}
