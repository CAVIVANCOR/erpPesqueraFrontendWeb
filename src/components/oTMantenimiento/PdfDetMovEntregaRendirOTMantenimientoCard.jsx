/**
 * PdfDetMovEntregaRendirOTMantenimientoCard.jsx
 *
 * Card para gestión de PDF de comprobante de movimiento de entrega a rendir en OT de mantenimiento.
 * Permite subir, visualizar y descargar el PDF del comprobante.
 * Replicado de PdfDetMovEntregaRendirContratoCard.jsx
 *
 * @author ERP Megui
 * @version 1.0.0
 */
...
const PdfDetMovEntregaRendirOTMantenimientoCard = ({
  ...
  const handleDescargarPDF = () => {
    descargarPdf(
      urlComprobanteMovimiento,
      toast?.current,
      `comprobante-mov-ot-mantenimiento-${movimientoIdNumber || 'documento'}.pdf`
    );
  };
      ...
      <div className="p-fluid">
        ...
        {mostrarCaptura && movimientoIdNumber && (
          <DocumentoCapture
            ...
            }/det-movs-entrega-rendir-ot-mantenimiento-pdf/upload-pdf-comprobante`}
