/**
 * Formulario para gestión de Destinos de Producto
...
const DestinoProductoForm = ({ destinoProducto, onGuardar, onCancelar }) => {
  ...
  useEffect(() => {
    if (destinoProducto) {
      setValue("nombre", destinoProducto.nombre || "");
      setValue("descripcion", destinoProducto.descripcion || "");
      setValue("activo", destinoProducto.activo !== undefined ? destinoProducto.activo : true);
      setValue("paraCompras", destinoProducto.paraCompras || false);
      setValue("paraVentas", destinoProducto.paraVentas || false);
    } else {
      reset({
        nombre: "",
        descripcion: "",
  ...
  }, [destinoProducto, setValue, reset]);
