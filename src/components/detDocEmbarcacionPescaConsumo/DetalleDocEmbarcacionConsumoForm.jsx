...
const DetalleDocEmbarcacionConsumoForm = ({
  formData,
  errors,
  handleInputChange,
  handleDateChange,
      ...
      <div className="field col-12">
        <div className="flex align-items-center">
          <Checkbox
            inputId="vigente"
            name="vigente"
            checked={formData.vigente || false}
            onChange={handleCheckboxChange}
            disabled={readOnly}
          />
          <label htmlFor="vigente" className="ml-2">Vigente</label>
        </div>
      </div>
      ...
      {pdfUrl && (
        <div className="field col-12">
          ...
          <div className="mb-2">
            <PDFActionButtons
              pdfUrl={pdfUrl}
              moduleName="detalle-doc-embarcacion-consumo"
              fileName={`doc-embarcacion-consumo-${formData.id || 'nuevo'}.pdf`}
              viewButtonLabel="Ver"
...
export default DetalleDocEmbarcacionConsumoForm;