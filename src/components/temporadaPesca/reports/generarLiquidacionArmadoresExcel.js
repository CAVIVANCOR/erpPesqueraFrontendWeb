// src/components/temporadaPesca/reports/generarLiquidacionArmadoresExcel.js
import ExcelJS from 'exceljs';
import { consultarTipoCambioSunat } from '../../../api/consultaExterna';
import { formatearNumero } from '../../../utils/utils';

export async function generarLiquidacionArmadoresExcel(data) {
  const { temporada, cuotas, descargas, adelantos } = data;

  const workbook = new ExcelJS.Workbook();
  const worksheet = workbook.addWorksheet('Liquidacion Armadores');
  ...
  tituloPrincipalCell.value = "LIQUIDACION DE PESCA INDUSTRIAL ARMADORES";
  ...
  cuotas.forEach((cuota, idx) => {
    ...
    const rowData = [
      ...
      Number(temporada.precioPorTonAlquilerDolares || 0),
