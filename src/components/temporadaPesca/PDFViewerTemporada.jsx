/**
 * PDFViewerTemporada.jsx - Componente específico para temporadas de pesca
 *
 * Componente para visualizar PDFs de resoluciones ministeriales de temporadas con autenticación JWT.
 ...
 */
const PDFViewerTemporada = ({ urlDocumento }) => {
  ...
  useEffect(() => {
    ...
    const cargarPDF = async () => {
      try {
        ...
        // Construir URL completa para resoluciones de temporada
        let urlCompleta;

        if (urlDocumento.startsWith('/uploads/resoluciones-temporada/')) {
          // Formato resoluciones: /uploads/resoluciones-temporada/resolucion-temporada-123.pdf
          // Convertir a: /temporada-pesca-resolucion/archivo/resolucion-temporada-123.pdf
          const rutaArchivo = urlDocumento.replace('/uploads/resoluciones-temporada/', '');
...
export default PDFViewerTemporada;
