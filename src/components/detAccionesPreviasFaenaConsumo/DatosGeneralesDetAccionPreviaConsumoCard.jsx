// src/components/detAccionesPreviasFaenaConsumo/DatosGeneralesDetAccionPreviaConsumoCard.jsx
// Card para datos generales de DetAccionesPreviasFaenaConsumo. Cumple la regla transversal ERP Megui.
...
export default function DatosGeneralesDetAccionPreviaConsumoCard({
  control,
  acciones,
  personal = [],
  loading,
