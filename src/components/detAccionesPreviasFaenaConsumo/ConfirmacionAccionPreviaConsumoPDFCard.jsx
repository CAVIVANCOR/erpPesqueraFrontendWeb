  ...
  return (
    <>
      <Card
        ...
        subTitle="Documento de confirmación de la acción previa realizada (Consumo)"
        className="mb-4"
      >
            ...
            >
              ...
              <div style={{ flex: 2 }}>
                {pdfUrl && (
                  <PDFActionButtons
                    pdfUrl={pdfUrl}
                    moduleName="confirmaciones-acciones-previas-consumo"
                    fileName={`confirmacion-accion-previa-consumo-${entityId || "sin-id"}.pdf`}
                    viewButtonLabel="Ver"
      ...
      <PDFMultiCapture
        ...
        moduleName="confirmaciones-acciones-previas-consumo"
        entityId={entityId}
        dialogTitle="Subir Confirmación de Acción Previa (Consumo)"
