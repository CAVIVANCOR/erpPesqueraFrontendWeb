// src/components/detAccionesPreviasFaenaConsumo/ConfirmacionAccionPreviaConsumoPDFCard.jsx
// Card para confirmación PDF de DetAccionesPreviasFaenaConsumo. Cumple la regla transversal ERP Megui.
...
import { actualizarDetAccionesPreviasFaenaConsumo } from "../../api/detAccionesPreviasFaenaConsumo";

export default function ConfirmacionAccionPreviaConsumoPDFCard({
  control,
  loading,
  setValue,
  watch,
  ...
  accionPreviaId,
  faenaPescaConsumoId,
  detAccionesPreviasFaenaConsumoId, // ID del registro para actualizar
}) {
  ...
  useEffect(() => {
    const actualizarVerificacion = async () => {
      ...
      if (
        ...
        detAccionesPreviasFaenaConsumoId && 
        !verificado && 
        !loading
      ) {
        ...
        try {
          ...
          const resultado = await actualizarDetAccionesPreviasFaenaConsumo(detAccionesPreviasFaenaConsumoId, {
  ...
  }, [urlConfirmaAccionPdf, detAccionesPreviasFaenaConsumoId, verificado, loading, setValue, toast]);
              ...
              <Button
                ...
                onClick={() =>
                  descargarPdf(
                    ...
                    }-faena-consumo-${faenaPescaConsumoId || "sin-faena"}.pdf`,
