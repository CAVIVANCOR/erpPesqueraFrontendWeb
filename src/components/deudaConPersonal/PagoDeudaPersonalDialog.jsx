// src/components/deudaConPersonal/PagoDeudaPersonalDialog.jsx
...
const PagoDeudaPersonalDialog = ({
  ...
  const handleSubmit = () => {
    const data = {
      deudaConPersonalId: Number(deudaId),
      fechaPago,
...
export default PagoDeudaPersonalDialog;