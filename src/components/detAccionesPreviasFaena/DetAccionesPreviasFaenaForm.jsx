...
import DatosGeneralesDetAccionPreviaCard from "./DatosGeneralesDetAccionPreviaCard";
import ConfirmacionAccionPreviaPDFCard from "./ConfirmacionAccionPreviaPDFCard";

export default function DetAccionesPreviasFaenaForm({
  isEdit,
  defaultValues,
  faenas,
  acciones,
  ...
  const {
    ...
    defaultValues: {
      faenaPescaId: defaultValues.faenaPescaId ? Number(defaultValues.faenaPescaId) : null,
  ...
  const renderCurrentCard = () => {
    switch (currentCard) {
      case 0:
        return (
          <DatosGeneralesDetAccionPreviaCard
            control={control}
            acciones={acciones}
            personal={personal}
            loading={loading}
