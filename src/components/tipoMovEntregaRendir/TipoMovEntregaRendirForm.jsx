...
export default function TipoMovEntregaRendirForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
  ...
  const [esIngreso, setEsIngreso] = React.useState(defaultValues.esIngreso !== undefined ? !!defaultValues.esIngreso : false);
  ...
  React.useEffect(() => {
    ...
    setEsIngreso(defaultValues.esIngreso !== undefined ? !!defaultValues.esIngreso : false);
  ...
  return (
    <form onSubmit={handleSubmit} className="p-fluid">
      ...
      <div className="p-field-checkbox">
        <Checkbox id="esIngreso" checked={esIngreso} onChange={e => setEsIngreso(e.checked)} disabled={loading} />
        <label htmlFor="esIngreso">Es Ingreso</label>
      </div>
      <div className="p-field-checkbox">
