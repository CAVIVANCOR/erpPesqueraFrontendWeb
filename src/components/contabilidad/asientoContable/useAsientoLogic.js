...
export default function useAsientoLogic({
  ...
  const [formData, setFormData] = useState({
    ...
    submoduloOrigenId: defaultValues?.submoduloOrigenId ? Number(defaultValues.submoduloOrigenId) : null,
    procesoOrigenId: defaultValues?.procesoOrigenId ? Number(defaultValues.procesoOrigenId) : null,
    submoduloOrigen: defaultValues?.submoduloOrigen || null,
