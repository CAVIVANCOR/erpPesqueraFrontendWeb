...
export default function ModuloSistemaForm({ initialValues, onSubmit, onCancel, loading }) {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="p-fluid">
        <div className="p-field">
          ...
          <InputText id="nombre" {...register('nombre', { required: 'El nombre es obligatorio' })} autoFocus />
