...
export default function DocumentoPescaForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
  ...
  const [obligatorio, setObligatorio] = React.useState(defaultValues.obligatorio !== undefined ? !!defaultValues.obligatorio : false);
  ...
  React.useEffect(() => {
    ...
    setObligatorio(defaultValues.obligatorio !== undefined ? !!defaultValues.obligatorio : false);
  ...
  return (
    <form onSubmit={handleSubmit} className="p-fluid">
      ...
      <div className="p-field-checkbox">
        <Checkbox id="obligatorio" checked={obligatorio} onChange={e => setObligatorio(e.checked)} disabled={loading} />
