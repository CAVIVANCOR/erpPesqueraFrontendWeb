/**
 * PdfDetMovEntregaRendirContratoCard.jsx - WRAPPER para Sistema PDF V2
 *
 * Componente wrapper para comprobantes de movimientos de entrega a rendir en contratos de servicios.
...
export default PdfDetMovEntregaRendirContratoCard;