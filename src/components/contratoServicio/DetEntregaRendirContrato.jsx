// src/components/contratoServicio/DetEntregaRendirContrato.jsx
// Componente para gestión de detalle de entregas a rendir en contratos de servicios
...
import DetMovsEntregaRendirContratoForm from "./DetMovsEntregaRendirContratoForm";
import { getResponsiveFontSize } from "../../utils/utils";
import {
  crearDetMovsEntregaRendirContratoServicios,
  actualizarDetMovsEntregaRendirContratoServicios,
  eliminarDetMovsEntregaRendirContratoServicios,
} from "../../api/detMovsEntregaRendirContratoServicios";
import { actualizarEntregaARendirContratoServicios } from "../../api/entregaARendirContratoServicios";

export default function DetEntregaRendirContrato({
  entregaARendir,
  movimientos = [],
  personal = [],
  centrosCosto = [],
  ...
  const handleGuardarMovimiento = async (data) => {
    try {
      if (editingMovimiento) {
        ...
        await crearDetMovsEntregaRendirContratoServicios(data);
        toast.current?.show({
          severity: "success",
          summary: "Éxito",
  ...
  const handleEliminarMovimiento = (movimiento) => {
    confirmDialog({
      ...
      accept: async () => {
        try {
          await eliminarDetMovsEntregaRendirContratoServicios(movimiento.id);
          toast.current?.show({
            severity: "success",
            summary: "Éxito",
      ...
      accept: async () => {
        try {
          ...
          const entregaActualizada = {
            contratoServicioId: entregaARendir.contratoServicioId,
  ...
  return (
    <>
      ...
      >
        <DetMovsEntregaRendirContratoForm
          movimiento={editingMovimiento}
          entregaARendirContratoServicioId={entregaARendir?.id}
          personal={personal}
