/**
 * PdfDetMovRendicionGastosCard.jsx - WRAPPER para Sistema PDF V2
 *
 * Componente wrapper para comprobantes de movimientos de rendición de gastos.
...
/**
 * Componente PdfDetMovRendicionGastosCard
 ...
 */
const PdfDetMovRendicionGastosCard = ({
  control,
  errors,
  setValue,
  watch,
...
export default PdfDetMovRendicionGastosCard;
