// src/components/familiaProducto/FamiliaProductoForm.jsx
// Formulario profesional para FamiliaProducto. Cumple la regla transversal ERP Megui.
...
export default function FamiliaProductoForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
