// src/components/color/ColorForm.jsx
// Formulario profesional para Color. Cumple la regla transversal ERP Megui.
import React from 'react';
import { Button } from 'primereact/button';
import { InputText } from 'primereact/inputtext';
import { InputTextarea } from 'primereact/inputtextarea';

export default function ColorForm({ isEdit, defaultValues, onSubmit, onCancel, loading }) {
