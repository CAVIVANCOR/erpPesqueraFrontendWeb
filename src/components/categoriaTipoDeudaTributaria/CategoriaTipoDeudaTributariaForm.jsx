// src/components/categoriaTipoDeudaTributaria/CategoriaTipoDeudaTributariaForm.jsx
...
const CategoriaTipoDeudaTributariaForm = ({
  isEdit,
  defaultValues,
  onSubmit,
  onCancel,
          ...
          render={({ field, fieldState }) => (
            <div className="p-inputgroup">
              ...
              <InputText
                ...
                disabled={loading}
                maxLength={100}
                placeholder="Ej: Impuestos Nacionales, Contribuciones Sociales"
              />
            </div>
          )}
        />
...
export default CategoriaTipoDeudaTributariaForm;