...
import { getDocumentosPesca, crearDocumentoPesca, actualizarDocumentoPesca, eliminarDocumentoPesca } from "../api/documentoPesca";
  ...
  return (
    <div className="p-fluid">
      ...
      <DataTable value={items} loading={loading} dataKey="id" paginator rows={10} onRowClick={e => handleEdit(e.data)} style={{ cursor: "pointer" }}>
        ...
        <Column field="obligatorio" header="Obligatorio" body={rowData => rowData.obligatorio ? "Sí" : "No"} />
      ...
      <Dialog header={editing ? "Editar Documento de Pesca" : "Nuevo Documento de Pesca"} visible={showDialog} style={{ width: 500 }} onHide={() => setShowDialog(false)} modal>
        <DocumentoPescaForm
          isEdit={!!editing}
