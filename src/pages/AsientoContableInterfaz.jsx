...
// Pantalla CRUD profesional para AsientoContableInterfaz. Cumple la regla transversal ERP Megui.
...
/**
 * Pantalla profesional para gestión de Asientos Contables Interfaz.
 ...
 */
export default function AsientoContableInterfaz() {
  ...
  return (
    <div className="p-fluid">
      ...
      <DataTable value={items} loading={loading} dataKey="id" paginator rows={10} onRowClick={e => handleEdit(e.data)} style={{ cursor: "pointer" }}>
        ...
        <Column field="cuentaContable" header="Cuenta Contable" />
