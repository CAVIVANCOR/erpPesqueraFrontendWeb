...
// Pantalla CRUD profesional para TipoMantenimiento. Cumple la regla transversal ERP Megui.
...
import { getAllTipoMantenimiento, createTipoMantenimiento, updateTipoMantenimiento, deleteTipoMantenimiento } from "../api/tipoMantenimiento";
import { useAuthStore } from "../shared/stores/useAuthStore";

/**
 * Pantalla profesional para gestión de Tipos de Mantenimiento.
 ...
 */
export default function TipoMantenimiento() {
  ...
  const cargarItems = async () => {
    setLoading(true);
    try {
      const data = await getAllTipoMantenimiento();
      setItems(data);
    } catch (err) {
  ...
  const handleDeleteConfirm = async () => {
    ...
    setLoading(true);
    try {
      await deleteTipoMantenimiento(toDelete.id);
  ...
  return (
    <div className="p-fluid">
      ...
      <Dialog header={editing ? "Editar Tipo de Mantenimiento" : "Nuevo Tipo de Mantenimiento"} visible={showDialog} style={{ width: 500 }} onHide={() => setShowDialog(false)} modal>
