...
const MotivoAcceso = () => {
  ...
  const [motivoAccesoSeleccionado, setMotivoAccesoSeleccionado] =
    useState(null);
  ...
  const onGuardar = () => {
    ...
    toast.current?.show({
      severity: "success",
      summary: "Éxito",
      detail: motivoAccesoSeleccionado
        ? "Motivo de acceso actualizado correctamente"
        : "Motivo de acceso creado correctamente",
    });
  };
    ...
    try {
      ...
      toast.current?.show({
        ...
        detail:
          ...
          "Error al eliminar el motivo de acceso",
      });
    }
  };
  ...
  return (
    <div className="motivo-acceso-page">
            ...
            <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
              ...
              <div className="flex gap-2 mt-3 md:mt-0">
                <Button
                  ...
                  tooltip="Nuevo Motivo de Acceso"
                  raised
                  outlined
                  size="small"
      ...
      <Dialog
        ...
        header={
          motivoAccesoSeleccionado
            ? "Editar Motivo de Acceso"
            : "Nuevo Motivo de Acceso"
        }
        modal
        className="p-fluid"
