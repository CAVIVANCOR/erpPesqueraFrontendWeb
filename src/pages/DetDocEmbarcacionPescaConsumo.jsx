// src/pages/DetDocEmbarcacionPescaConsumo.jsx
// Pantalla CRUD profesional para DetDocEmbarcacionPescaConsumo. Cumple regla transversal ERP Megui:
...
/**
 * Componente DetDocEmbarcacionPescaConsumo
 * Gestión CRUD de documentación de embarcaciones de faenas con patrón profesional ERP Megui
 */
const DetDocEmbarcacionPescaConsumo = () => {
  ...
  const cargarDocumentos = async () => {
    try {
      ...
      toast.current?.show({
        severity: 'error',
        summary: 'Error',
        detail: 'Error al cargar documentos de embarcaciones'
      });
    } finally {
      setLoading(false);
    }
  ...
  const documentoTemplate = (rowData) => {
    if (!rowData.urlDocEmbarcacio) return '';
    return (
      <Button
        icon="pi pi-file-pdf"
        ...
        onClick={(e) => {
          e.stopPropagation();
          window.open(rowData.urlDocEmbarcacio, '_blank');
        }}
  ...
  return (
    <div className="det-doc-embarcacion-pesca-consumo-container">
      <Toast ref={toast} />
      <ConfirmDialog />
      
      <div className="card">
        <div className="flex justify-content-between align-items-center mb-4">
          <h2>Documentos de Embarcaciones - Faenas de Consumo</h2>
          <Button
        ...
        >
          ...
          <Column field="documentoPescaId" header="Tipo Doc ID" sortable style={{ width: '120px' }} />
          <Column 
      ...
      >
        <DetDocEmbarcacionPescaConsumoForm
...
export default DetDocEmbarcacionPescaConsumo;
