    ...
    <div className="p-m-4">
      ...
      <ConfirmDialog
        ...
        message={<span style={{ color: '#b71c1c', fontWeight: 600 }}>
          ¿Está seguro que desea <span style={{ color: '#b71c1c' }}>eliminar</span> el módulo <b>{confirmState.row ? confirmState.row.nombre : ''}</b>?<br/>
        ...
        style={{ minWidth: 400 }}
      />
      <DataTable value={modulos} loading={loading} paginator rows={10} selectionMode="single" selection={selected} onSelectionChange={e => setSelected(e.value)} onRowClick={onRowClick}>
