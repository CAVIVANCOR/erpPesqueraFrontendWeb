...
import DashboardUnidades from "./DashboardUnidades";
import DashboardUnidad from './DashboardUnidad';
    ...
    <div style={{ minHeight: "calc(100vh - 64px)", position: "relative" }}>
      ...
      <motion.button
        ...
        style={{
          ...
          boxShadow:
            "0 8px 32px rgba(93, 173, 226, 0.4), 0 0 0 0 rgba(93, 173, 226, 0.7)",
          cursor: "pointer",
          display: "flex",
            ...
            >
              ...
              >
                <p>
                  ...
                  para abrir este menú en cualquier momento
                </p>
              </div>
            </motion.div>
          </motion.div>
