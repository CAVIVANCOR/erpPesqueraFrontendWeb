...
const TipoPersona = () => {
  ...
  const onGuardar = () => {
    ...
    toast.current?.show({
      severity: "success",
      summary: "Éxito",
      detail: tipoPersonaSeleccionado
        ? "Tipo de persona actualizado correctamente"
        : "Tipo de persona creado correctamente",
    });
  };
  ...
  const eliminarTipoPersona = async (id) => {
    try {
      ...
      toast.current?.show({
        ...
        summary: "Error",
        detail:
          error.response?.data?.error || "Error al eliminar el tipo de persona",
      });
    }
  };
